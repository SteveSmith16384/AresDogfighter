...
/*
 * This tests the various particle effects
 */
public class ParticleEmitterTesting extends SimpleApplication {
    ...
    public static void main(String[] args){
    	ParticleEmitterTesting app = new ParticleEmitterTesting();
        app.start();
    }
...
//        shockwave.setRandomAngle(true);
    ...
    public void simpleInitApp() {
        ...
        //explosionEffect.lookAt(cam.getLocation(), Vector3f.UNIT_Y);
